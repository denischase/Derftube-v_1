...
<div class="content">
  ...
  <div class="col-sm-6">
    ...
    <div class="card text-center">
      <div class="card-body" style="background-color: #8ab593;">
        ...
        <?php 
      $id = $row1['id'];
       $query2 ="SELECT count(*) as total from movie,category where category.id=movie.cat_id and
       category.id=$id";
  ...
  <div class="btngen text-center" id="genbtn1">
    <button class="btn btn btn-lg" onclick="myfun()" style="background-color: #a68e68;width:190px;">Genre &#8681;&#8681;</button>
  </div>
  ...
  <div class="col-sm-6">
    ...
    <div class="card text-center">
      <div class="card-body" style="background-color: #a68e68;">
        ...
        <?php 
      $id = $row3['id'];
       $query4 ="SELECT count(*) as total_category from category,genre where genre.id=category.genre_id and
       genre.id=$id";
